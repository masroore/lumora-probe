...
for (const source of ['workspace-controller.js', 'tabs-controller.js', 'dialog-controller.js', 'association-controller.js', 'live-client.js', 'investigation-controller.js', 'workflow-controller.js']) {
  await build({
